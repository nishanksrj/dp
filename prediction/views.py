...
#     response = {}
#     try:
#         crop = response['crop'] =  request.GET.get('crop')
#         stage = response['stage'] = request.GET.get('stage')
#         lat = response['lat']  = request.GET.get('lat')
#         lng = response['lng'] = request.GET.get('lng')
